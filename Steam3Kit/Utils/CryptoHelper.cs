...
namespace Steam3Kit.Utils
{
    ...
    public static class CryptoHelper
    {
        ...
        public static byte[] SymmetricEncryptWithIV(byte[] input, byte[] key, byte[] iv)
        {
            ...
            Debug.Assert(key.Length == 32, "CryptoHelper", "SymmetricEncrypt used with non 32 byte key!");
        ...
        static byte[] SymmetricDecrypt(byte[] input, byte[] key, out byte[] iv)
        {
            ...
            Debug.Assert(key.Length == 32, "CryptoHelper", "SymmetricDecrypt used with non 32 byte key!");
        ...
        public static byte[] SymmetricDecryptECB(byte[] input, byte[] key)
        {
            ...
            Debug.Assert(key.Length == 32, "CryptoHelper", "SymmetricDecryptECB used with non 32 byte key!");
