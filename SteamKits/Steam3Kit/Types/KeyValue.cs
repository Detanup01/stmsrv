...
*/
/*
   Read thirdparty.txt for license of this file
*/
            ...
            while (true)
            {
                ...
                switch (type)
                {
                    ...
                    case Type.WideString:
                        {
                            Console.WriteLine("KeyValue", "Encountered WideString type when parsing binary KeyValue, which is unsupported. Returning false.");
                            return false;
                        }
